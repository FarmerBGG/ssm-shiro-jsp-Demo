			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/dev/flatform/main" class="site_title"><i class="fa fa-paw"></i> <span>WARE
								BMS</span>
						</a>
					</div>
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							<h3>${userSession.usercode }</h3>
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> 商品管理 <span
										class="fa fa-chevron-down"></span>
								</a>
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/warelist">商品查看</a>
										</li>
										<shiro:hasPermission name="ware:create">
										<li><a href="${pageContext.request.contextPath }/addware">商品添加</a>
										</li>
										</shiro:hasPermission>
									</ul>
								</li>
